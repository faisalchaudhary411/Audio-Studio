...
TOOL_PAGES = {
    ...
    "compress-audio": {
        ...
        "faq": [
            ...
            ("Is there a file size limit to upload?", "Yes, 10MB per file on the free tier."),
        ],
    ...
    "decompress-audio": {
        ...
        "how_it_works": [
            "Upload your compressed audio file (MP3, OGG, M4A, AAC, WMA — up to 10MB).",
    ...
    "remove-background-noise": {
        ...
        "faq": [
            ...
            ('What file types and size limits apply?', 'Typical uploads include common speech formats (for example MP3, WAV, M4A) up to the tool’s current size limit (around 10MB on free tools — check the uploader for the live limit). Output is optimized for speech cleanup workflows.'),
