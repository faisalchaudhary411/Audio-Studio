...
URDU_SCRIPT_WORD_MAP = {
    ...
    "چاہیے": "चाहिए", "نہ": "ना", "زندگی": "ज़िंदगी", "ایک": "एक", "خاص": "खास",
    "تحفہ": "तोहफा", "ہم": "हम", "سب": "सब", "خوش": "खुश", "چھوٹی": "छोटी",
    "خوشیاں": "खुशियां", "معنی": "मानी", "دیتی": "देती", "صبح": "सुबह", "جلدی": "जल्दी",
    "اٹھنا": "उठना", "اچھی": "अच्छी", "اچھا": "अच्छा", "اچھے": "अच्छे", "عادت": "आदत",
    "اس": "इस", "دن": "दिन", "بنتا": "बनता", "کتابوں": "किताबों", "سیکھنا": "सीखना",
    "سیکھنے": "सीखने", "علم": "इल्म", "انسان": "इंसान", "طاقت": "ताकत", "دیتا": "देता",
    "ہمیشہ": "ہمیشہ", "کچھ": "कुछ", "نیا": "नया", "نئی": "नयी", "ذہن": "ज़हन",
    "کھلتا": "खुलता", "کھلا": "खुला", "باتیں": "बातें", "سمجھتا": "समझता",
    "سمجھ": "समझ", "آسان": "आसान", "بنتی": "बनती", "پسند": "पसंद", "دوستی": "दोस्ती",
    "بناتی": "बनाती", "دوست": "दोस्त", "ساتھ": "साथ", "دیتے": "देते", "مشکل": "मुश्किल",
    "وقت": "वक्त", "ہی": "ही", "کام": "काम", "آتے": "آتے", "محبت": "मोहब्बत",
    "خلوص": "ख़ुलूस", "دلوں": "दिलों", "ملاتی": "मिलाती", "لوگوں": "लोगों",
    "مدد": "मदद", "دینا": "देना", "عمل": "अमल", "دل": "दिल", "ہوتا": "होता",
    "آتا": "آتا", "امید": "उम्मीद", "آگے": "आगे", "لے": "ले", "جاتی": "जाती",
    "خواب": "ख्वाब", "دیکھنا": "देखना", "بات": "बात", "خوابوں": "ख्वाबों",
    "سچ": "सच", "بنانے": "बनाने", "محنت": "मेहनत", "کبھی": "कभी", "ضائع": "ज़ाया",
    "نہیں": "नहीं", "انسانوں": "इंसानों", "کوئی": "कोई", "خاصیت": "खासियत",
    "ہوتی": "होती", "اپنے": "अपने", "آپ": "आप", "یقین": "यकीन", "اہم": "अहम",
    "ہمت": "हिम्मत", "ملتی": "मिलती", "ملتا": "मिलता", "کامیابی": "कामयाबी",
    "مستقل": "मुस्तकिल", "مزاجی": "मिज़ाजी", "سوچ": "सोच", "مثبت": "मुस्बत",
    "فائدہ": "फ़ायदा", "دونوں": "दोनों", "حالتوں": "हालतों", "سکون": "सुकून",
    "فیصلے": "फैसले", "ہوتے": "होते", "مستقبل": "मुस्तक़बिल", "آج": "आज",
    "پھل": "फल", "سچائی": "सच्चाई", "معلوم": "मालूम", "ہونی": "होनी",
    "اور": "और", "ساتھی": "साथी", "تعلیم": "तालीम", "نعمت": "नेमत",
    "استاد": "उस्ताद", "طالب": "तालिब", "علموں": "इल्मوں", "بدل": "बदल",
    "تنہا": "तन्हा", "نیکی": "नेकी", "بدلہ": "बदला", "خدمت": "ख़िदमत",
    "لوگ": "लोग", "بناتے": "बनाते", "اچھائی": "अच्छाई", "ملتے": "मिलते",
    "نیکیاں": "नेकियां", "خوشی": "खुशी", "بڑھاتا": "बढ़ाता", "والا": "वाला"
}
...
ROMAN_URDU_FIXES = {
    ...
    r"\bmawar\b": "mor", r"\braste\b": "raste", r"\bmuskl\b": "mushkil"
}

ROMAN_TO_DEVANAGARI_WORDS = {
    "ki": "कि", "kee": "की", "ka": "का", "ke": "के", "ko": "को", "bhi": "भी", "kal": "कल",
    ...
    "liye": "लिए", "mehnat": "मेहनت", "kabhi": "कभी", "zaya": "ज़ाया",
    ...
    "milta": "मिलता", "kaamyabi": "कामयाबी", "mustaqil": "मुस्तक़िल",
    ...
    "badla": "बदला", "khidmat": "ख़िदमत", "log": "लोग", "banate": "बनाते",
    ...
    "bikherte": "बिखेरती", "to": "तो", "hameen": "हमें", "yaad": "याद",
    "dilati": "दिलाती", "mauqa": "मौका", "aati": "आती", "doston": "दोस्तों",
    "suhbat": "सोहबत", "buzurgon": "बुज़ुर्गों", "izzat": "इज़्ज़त", "karna": "करना",
    "mayno": "मायनों", "insaniyat": "इंसानियत", "jodne": "जोड़ने", "kisi": "किसी",
    "sakte": "सकते", "zaroor": "ज़रूर", "karen": "करें", "kyunke": "क्योंकि",
    "khubsurat": "खूबसूरत", "zaroori": "ज़रूरी", "raat": "रात", "ghabrana": "घबराना",
    "andheri": "अंधेरी", "baad": "बाद", "roshan": "रोशन", "rakhein": "रखिए",
    "khud": "खुद", "bharosa": "भरोसा", "duniya": "दुनिया", "rok": "रोक",
    "mil": "मिल", "rahein": "रहें", "akela": "अकेला", "thak": "थक",
    "jaata": "जाता", "koshish": "कोशिश", "khazana": "ख़ज़ाना", "baantne": "बांटने",
    "shukr": "शुक्र", "ada": "अदा"
}


def fallback_roman_to_devanagari(word: str) -> str:
    """Robust regex-based phonetic transliteration for OOV Roman Urdu words."""
    w = word.lower().strip()
